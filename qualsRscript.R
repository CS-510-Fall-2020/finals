...
#highlight p1, p2, p3, p4 and the plot_grid and run them all once or together.
...
plot_grid(p1,p2,p3,p4,labels=c("(a)","(b)","(c)","(d)"),label_size=12)##change A, B,C, D to a, b, c, d to get what is in the original paper
